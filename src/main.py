...
#general params
    ...
    parser.add_argument('--episodes', help='Number of episodes for DDQN(run from beginning to terminal state).', type=int, default=100000)
#A3C pararms
...
#DDQN paramrs
    ...
    parser.add_argument('--eps_decay', help='after every episode "eps" is multiplied by "eps_decay" to reduces exploration over time', type=float, default=0.999)
    ...
    parser.add_argument('--lr_gamma', help='learning rate decay for the Q-Network', type=float, default=0.9)
    parser.add_argument('--lr_step', help='every "lr_step" episodes we decay the learning rate', type=int, default=100)
    ...
    parser.add_argument('--hidden_dim', help='hidden dimensions for the Q_network', type=int, default=64)
